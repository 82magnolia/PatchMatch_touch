#!/usr/bin/env bash
# Coarse transfer (superpoint+superglue, normal modality, 4x match scale) over
...
OUT=$ROOT/log/transfer_feat_match_pseudo_mini_tactile_normal_superpoint_superglue_normalmatch
cd "$ROOT"
