...
export TARF_TRAIN_CONFIG="configs/patchmatch_sim_tactile_normal_rebot_finetune_train.yaml"
export TARF_RUN_NAME="patchmatch_sim_tactile_normal_rebot_finetune"
