...
# superpoint_lightglue feature matcher backend (image-matching-webui) instead of loftr.
#
# Usage: bash run_superpoint_lightglue.sh
...
OUT_BASE="$PROJECT_ROOT/log/transfer_pipeline_real_data_gt_retrieval_superpoint_lightglue"
...
for session_dir in "$SESSIONS_BASE"/*/; do
    ...
    python "$PIPELINE_SCRIPT" \
        ...
        --transfer_offset_matcher   superpoint_lightglue \
