#!/usr/bin/env bash
# Same as run_superpoint_lightglue.sh (superpoint_lightglue, modality=curvature,
...
#
# Usage: bash run_refined_superpoint_lightglue.sh
...
# override e.g. `NUM_THREADS=7 bash run_refined_superpoint_lightglue.sh` when running 4-way in parallel on 28 cores.
...
OUT_BASE="$PROJECT_ROOT/log/transfer_pipeline_real_data_gt_retrieval_refined_superpoint_lightglue"
