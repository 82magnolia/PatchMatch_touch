#!/usr/bin/env bash
# Pretrain a CONDITIONED ReBotNet XS on gelsight_pseudo_mini in sim.
...
#
# Usage: bash train_refine_scripts/train_rebot_pseudo_mini_cond/train_rebot_XS.sh <gpu_id> [matcher] [cond_mode] [data_mode]
