...
# Usage: bash train_refine_scripts/train_rebot_pseudo_mini_tactile_normal/train_rebot_L.sh <gpu_id> [matcher]
...
CUDA_VISIBLE_DEVICES=$GPU python "$PROJECT_ROOT/rebot_net/train.py" \
    ...
    --save_dir      "$PROJECT_ROOT/log/rebot_checkpoints_L_pseudo_mini_tactile_normal${SUFFIX}" \
