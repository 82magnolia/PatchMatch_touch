...
#
# Usage: bash pipeline_scrips/eval_pipeline_real_data_gt_retrieval/eval_pipeline_S.sh <gpu_id> [matcher] [masked]
...
OUT_BASE="$PROJECT_ROOT/log/pipeline_eval_S_real_data_gt_retrieval${SUFFIX}"
