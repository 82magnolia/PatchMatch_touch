...
# residual-mode refinement) on the gelsight_pseudo_mini test split, via
...
#
# Usage: bash pipeline_scrips/eval_pipeline_pseudo_mini_residual/eval_pipeline_XS.sh <gpu_id> [matcher] [masked]
...
OUT_BASE="$PROJECT_ROOT/log/pipeline_eval_XS_pseudo_mini${NAME_SUFFIX}"
