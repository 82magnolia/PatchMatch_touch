...
#
# Usage: bash pipeline_scrips/eval_pipeline_pseudo_mini/eval_pipeline_M.sh <gpu_id> [matcher] [masked]
...
OUT_BASE="$PROJECT_ROOT/log/pipeline_eval_M_pseudo_mini${SUFFIX}"
