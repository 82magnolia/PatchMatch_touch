...
\begin{figure*}[t]
  ...
  \caption{\textbf{Comparison against baselines on the full pipeline benchmark.} Each block of
    ...
    dynamics and its sharp creases. \emph{(e)} Our refined prediction, and \emph{(f)} the ground
    truth at the query location. Only our refined result tracks how the contact grows and recedes
